  ...
  public async logSuccess(context: ISuccessLogContext): Promise<void> {
    await this.priceRepository.logRequest({
      ...
      result: {
        ...
        grossToAmount: context.response.grossToAmount,
        feeAmount: context.response.feeAmount,
        feeAmountSymbol: context.response.feeAmountSymbol,
        feeBps: context.response.feeBps,
        feeMode: context.response.feeMode,
        feeType: context.response.feeType,
        feeDisplayLabel: context.response.feeDisplayLabel,
